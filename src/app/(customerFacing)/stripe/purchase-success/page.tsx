...
export default async function SuccessPage({
  ...
  logging({rootPath:"(customerFacing)/stripe/purchase-success/page.tsx[17]",func:"SuccessPage"})
      ...
      <div className="flex gap-4 items-center">
        ...
        <div>
          ...
          <Button className="mt-4" size="lg" asChild>
            {isSuccess ? (
              // This is a link for some period of tome for downloading the product by the customer
...
async function createDownloadVerification(productId: string) {
  logging({rootPath:"(customerFacing)/stripe/purchase-success/page.tsx[64]",func:"createDownloadVerification"})
